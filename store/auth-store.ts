...
export const set_user_value = (auth: AUTHRECORD) => useAuthStore.getState().setAuth(auth);
export const set_kyc_value = (kyc: USER_KYC) => useAuthStore.getState().setKyc(kyc);
