                ...
                <View style={tw`p-4 pb-40`}>
                  ...
                  {property.fractionalHoldingPeriodDays != null && (
                    ...
                    >
                      ...
                      <Text style={[tw`text-xs flex-1 leading-5`, { color: "#92400E" }]}>
                        Minimum holding period: {property.fractionalHoldingPeriodDays} days. Early exit may incur a penalty.
                      </Text>
                    </View>
                  )}
                  ...
                  >
                    ...
                    <View style={tw`flex-row items-center justify-between mt-3`}>
                      <TouchableOpacity
                        onPress={() => {
                          if (quantity > minimumShares) form.setValue("quantity", quantity - 1);
                        }}
                        disabled={quantity <= minimumShares}
                        style={[
                          tw`w-10 h-10 rounded-xl items-center justify-center border`,
                          {
                            borderColor: quantity <= minimumShares ? Colors.divider : Colors.brand,
                            backgroundColor: quantity <= minimumShares ? "#F9FAFB" : Colors.brand + "10",
                          },
                        ]}
                      >
                        <Ionicons
                          name="remove"
                          size={20}
                          color={quantity <= minimumShares ? Colors.textMuted : Colors.brand}
                        />
                      </TouchableOpacity>
                      ...
                      <TouchableOpacity
                        onPress={() => {
                          if (quantity < availableShares) form.setValue("quantity", quantity + 1);
                        }}
                        disabled={availableShares > 0 && quantity >= availableShares}
                        style={[
                          tw`w-10 h-10 rounded-xl items-center justify-center border`,
                          {
                            borderColor:
                                ...
                                <View>
                                  ...
                                  {property.fractionalHoldingPeriodDays != null && (
                                    <Text style={[tw`text-xs`, { color: Colors.textMuted }]}>
                                      Holding: {property.fractionalHoldingPeriodDays} days
                                    </Text>
                                  )}
                                </View>
                              </View>
                  ...
                  >
                    ...
                    <View style={tw`gap-2`}>
                      <View style={tw`flex-row justify-between`}>
                        <Text style={[tw`text-sm`, { color: Colors.textSecondary }]}>Shares × {quantity}</Text>
                        <Text style={[tw`text-sm font-semibold`, { color: Colors.textPrimary }]}>{fmt(sharesTotal)}</Text>
                      </View>
                      {fees.length > 0 && (
                        <View style={tw`flex-row justify-between`}>
                  ...
                  {selectedTier && expectedPayout && (
                    ...
                    >
                      <View style={tw`flex-row items-center gap-2`}>
                        ...
                        <Text style={[tw`text-sm font-medium`, { color: "#065F46" }]}>
